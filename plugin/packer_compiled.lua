...
_G.packer_plugins = {
  ...
  ["codewindow.nvim"] = {
    loaded = true,
    path = "/Users/samuel.lawerence/.local/share/nvim/site/pack/packer/start/codewindow.nvim",
  ...
  ["nvim-surround"] = {
    loaded = true,
    path = "/Users/samuel.lawerence/.local/share/nvim/site/pack/packer/start/nvim-surround",
  ...
  ["snipe.nvim"] = {
    loaded = true,
    path = "/Users/samuel.lawerence/.local/share/nvim/site/pack/packer/start/snipe.nvim",
  ...
  ["yanky.nvim"] = {
    loaded = true,
    path = "/Users/samuel.lawerence/.local/share/nvim/site/pack/packer/start/yanky.nvim",
