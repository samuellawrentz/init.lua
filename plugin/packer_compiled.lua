...
_G.packer_plugins = {
  ...
  ["barbar.nvim"] = {
    loaded = true,
    path = "/Users/samuel.lawerence/.local/share/nvim/site/pack/packer/start/barbar.nvim",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/Users/samuel.lawerence/.local/share/nvim/site/pack/packer/start/typescript.nvim",
